...
public class User {
    ...
    private static ArrayList<User> scoreboard;
    ...
    public static game.User getUserByName(String username) {
        for (game.User user : allUsers) {
    ...
    public boolean hasHigherRankThan(game.User otherUser) {
    ...
    public static void sortScoreBoard() {
        ...
        game.User tempMaxRank;
        for (int i = 0; i < allUsers.size(); i++) {
            tempMaxRank = null;
            for (game.User user : listCopy) {
